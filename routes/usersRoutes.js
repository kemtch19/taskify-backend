...
} = require("../middlewares/validators/user/registerValidator");
const {
  loginUserValidator,
} = require("../middlewares/validators/user/loginValidator");
const validateResult = require("../middlewares/validators/errors/validateResult");
const authMiddleware = require("../middlewares/authMiddleware");
const uploadMiddleware = require("../middlewares/uploadMiddleware");
const {
  changePasswordValidator,
} = require("../middlewares/validators/user/usersValidator");
